...
import 'package:ephyli/screen/activity/activity_c13a1.dart';
...
import 'package:ephyli/screen/activity/activity_c8a1.dart';
import 'package:ephyli/screen/activity/activity_c9a2.dart';
...
import '../screen/activity/activity_c9a1.dart';
    ...
    if (context.mounted) {
      switch (activityID) {
        ...
        case "c7a1":
          ...
          break;
        case "c8a1":
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => ActivityC8A1(),)).then((value) {
            setState(() {});
          },);
          break;
        case "c9a1":
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => ActivityC9A1(),)).then((value) {
            setState(() {});
          },);
          break;
        case "c9a2":
        ...
        case "c11a1":
          ...
          break;
        case "c12a1":
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => ActivityC12A1(),)).then((value) {
            setState(() {});
          },);
          break;
        case "c12a2":
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => ActivityC12A2(),)).then((value) {
            setState(() {});
          },);
          break;
        case "c13a1":
