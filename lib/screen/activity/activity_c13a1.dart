...
class _ActivityC13A1State extends State<ActivityC13A1> {
  ...
  C13A1Stage stage = C13A1Stage.introduction;
  ...
  Widget activityIntroView() {
    return InstructionsWidget(
        prefs,
        AppLocalizations.of(context)!.c11a1_instructions, //todo
  ...
  Widget activityFinishView() {
    return OrientationBuilder(builder: (context, orientation) {
      if (orientation == Orientation.portrait) {
        return InstructionsWidget(
            prefs,
            AppLocalizations.of(context)!.c11_finish, //todo
